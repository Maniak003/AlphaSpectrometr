...
color_fone="0xC0C0A0"
set title "AlphaSpecter. Pulses: 35 (35), Time: 17418 sec, CPS: 0.002009" textcolor rgb color_text
...
set xrange [0:4098]
set yrange [0:1]
set y2range [0:1.000000]
plot 'alpha-17112024.dat' using 1:2 with lines lc rgb color_lin notitle, 'alpha-17112024.dat' using 1:($2==0 ? 0 : log($2)) axes x1y2 with lines lc rgb color_log notitle
